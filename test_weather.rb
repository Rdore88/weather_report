...
class WeatherTest < Minitest::Test
  ...
  assert_equal "38.947712", Weather.new.get_weather(20011)["current_observation"]["observation_location"]["latitude"]
  end
  ...
  assert_equal  "18", Weather.new.sunrise_sunset(20011)["sun_phase"]["sunset"]["hour"]
  end
  ...
  assert_equal "Monday", Weather.new.ten_day_forecast(20011)["forecast"]["txt_forecast"]["forecastday"][0]["title"]
  end
  ...
  assert_equal [], Weather.new.current_alerts(20011)["alerts"]
  end
